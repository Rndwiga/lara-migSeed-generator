...
use Tyondo\Migratory\SeedsGenerator\TableNotFoundException;
use Tyondo\Migratory\SeedsGenerator\TyondoSeeder;

class SeederGenerateCommand extends Command
{
    /**
    ...
    protected $tyondoSeeder;


    public function __construct()
    {
        $this->tyondoSeeder = new TyondoSeeder();
        parent::__construct();
    }
    ...
    public function fire()
    {
        ...
        if ($this->option('clean')) {
            $this->tyondoSeeder->cleanSection();
        ...
        foreach ($tables as $table) {
            ...
            if (!File::exists($fileName) || $this->option('force')) {
                $this->printResult(
                    $this->tyondoSeeder->generateSeed(
                        $table,
                        $prefix,
                        $suffix,
    ...
    protected function generateFileName($table, $prefix=null, $suffix=null)
    {
        ...
        $className = $this->tyondoSeeder->generateClassName($table, $prefix, $suffix);
        $seedPath = base_path() . Config::get("migratory.path");
