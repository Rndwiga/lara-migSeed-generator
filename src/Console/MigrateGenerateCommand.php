<?php
namespace Tyondo\Migratory\Console;
...
use Tyondo\Migratory\MigrationsGenerator\Generators\Generator;
use Tyondo\Migratory\MigrationsGenerator\Generators\SchemaGenerator;
use Tyondo\Migratory\MigrationsGenerator\Syntax\AddToTable;
use Tyondo\Migratory\MigrationsGenerator\Syntax\DroppedTable;
use Tyondo\Migratory\MigrationsGenerator\Syntax\AddForeignKeysToTable;
use Tyondo\Migratory\MigrationsGenerator\Syntax\RemoveForeignKeysFromTable;
...
class MigrateGenerateCommand extends GeneratorCommand {
	...
	/**
	 * @var \Tyondo\Migratory\MigrationsGenerator\Generators\SchemaGenerator
	 */
	...
	{
	   // $this->generateSeeder = $this->argument('seeder');
		$this->fire();
	}
	...
	protected function generateTablesAndIndices( array $tables )
	{
		...
		foreach ( $tables as $table ) {
            ...
            if ($this->generateSeeder){
                $this->call('migrate:seeder',[$table]);
            }
