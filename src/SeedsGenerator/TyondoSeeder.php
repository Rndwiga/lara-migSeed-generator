...
namespace Tyondo\Migratory\SeedsGenerator;
...
class TyondoSeeder
{
    ...
    public function generateSeed($table, $prefix=null, $suffix=null, $database = null, $max = 0, $chunkSize = 0, $exclude = null, $prerunEvent = null, $postrunEvent = null, $dumpAuto = true, $indexed = true, $orderBy = null, $direction = 'ASC')
    {
        ...
        $stub = $this->readStubFile( Config::get("migratory.seed_template_path"));
    ...
    {
        return base_path() . Config::get("migratory.path");
    }
    ...
    {
        $chunkSize = $chunkSize ?: Config::get("migratory.chunk_size");
    ...
    {
        $databaseSeederPath = base_path() . Config::get("migratory.path") . '/DatabaseSeeder.php';
    ...
    {
        //TODO:: automatically check if the file exists, if not copy it to the dir
        $databaseSeederPath = base_path() . Config::get("migratory.path") . '/DatabaseSeeder.php';
